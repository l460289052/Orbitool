...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.timeSeriesCatSplitter = QtWidgets.QSplitter(parent=Form)
        self.timeSeriesCatSplitter.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.timeSeriesCatSplitter.setObjectName("timeSeriesCatSplitter")
        self.verticalLayoutWidget = QtWidgets.QWidget(parent=self.timeSeriesCatSplitter)
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayout_23 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout_23.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_23.setObjectName("verticalLayout_23")
        self.csvAddPushButton = QtWidgets.QPushButton(parent=self.verticalLayoutWidget)
        ...
        self.timeSeriesCatFileLabel = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        ...
        self.timeSeriesCatCsvTabWidget = QtWidgets.QTabWidget(parent=self.verticalLayoutWidget)
        ...
        self.scrollArea = QtWidgets.QScrollArea(parent=self.timeSeriesCatRawTab)
        ...
        self.rawTableWidget = QtWidgets.QTableWidget(parent=self.scrollAreaWidgetContents)
        self.rawTableWidget.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.rawTableWidget.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollMode.ScrollPerPixel)
        ...
        self.rawCustomRadioButton = QtWidgets.QRadioButton(parent=self.groupBox_10)
        self.rawCustomRadioButton.setObjectName("rawCustomRadioButton")
        self.gridLayout.addWidget(self.rawCustomRadioButton, 2, 0, 1, 1)
        self.rawCustomLineEdit = QtWidgets.QLineEdit(parent=self.groupBox_10)
        ...
        self.formLayout_11.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_30)
        self.rawTimeColumnLabel = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.rawTimeColumnLabel.setObjectName("rawTimeColumnLabel")
        self.formLayout_11.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.rawTimeColumnLabel)
        self.rawTimeColumnSpinBox = QtWidgets.QSpinBox(parent=self.scrollAreaWidgetContents)
        self.rawTimeColumnSpinBox.setMinimum(1)
        self.rawTimeColumnSpinBox.setObjectName("rawTimeColumnSpinBox")
        self.formLayout_11.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.rawTimeColumnSpinBox)
        self.rawFirstIonColumnLabel = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.rawFirstIonColumnLabel.setObjectName("rawFirstIonColumnLabel")
        self.formLayout_11.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.rawFirstIonColumnLabel)
        self.rawFirstIonColumnLineEdit = QtWidgets.QSpinBox(parent=self.scrollAreaWidgetContents)
        ...
        self.formLayout_11.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.rawFirstIonColumnLineEdit)
        self.rawIonRowLabel = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.rawIonRowLabel.setObjectName("rawIonRowLabel")
        self.formLayout_11.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.rawIonRowLabel)
        self.rawIonRowLineEdit = QtWidgets.QSpinBox(parent=self.scrollAreaWidgetContents)
        ...
        self.formLayout_11.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.rawIonRowLineEdit)
        self.verticalLayout_30.addLayout(self.formLayout_11)
        self.rawFinishPushButton = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.processedTableWidget = QtWidgets.QTableWidget(parent=self.timeSeriesCatProcessedTab)
        self.processedTableWidget.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.processedTableWidget.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollMode.ScrollPerPixel)
        ...
        self.rtolDoubleSpinBox = QtWidgets.QDoubleSpinBox(parent=self.verticalLayoutWidget)
        ...
        self.catPushButton = QtWidgets.QPushButton(parent=self.verticalLayoutWidget)
        self.catPushButton.setObjectName("catPushButton")
        self.verticalLayout_23.addWidget(self.catPushButton)
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(parent=self.timeSeriesCatSplitter)
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.verticalLayout_25 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.verticalLayout_25.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_25.setObjectName("verticalLayout_25")
        self.timeSeriesesTableWidget = QtWidgets.QTableWidget(parent=self.verticalLayoutWidget_2)
        ...
        self.timeSeriesesTableWidget.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.timeSeriesesTableWidget.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollMode.ScrollPerPixel)
        ...
        self.rmSelectedPushButton = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_2)
        ...
        self.rmAllPushButton = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.intSelectedPushButton = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.intAllPushButton = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.timeSeriesTableWidget = QtWidgets.QTableWidget(parent=self.verticalLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.timeSeriesTableWidget.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.timeSeriesTableWidget.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollMode.ScrollPerPixel)
        ...
        self.exportPushButton = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_2)
        ...
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(parent=self.timeSeriesCatSplitter)
        self.verticalLayoutWidget_3.setObjectName("verticalLayoutWidget_3")
        self.verticalLayout_26 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_3)
        self.verticalLayout_26.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_26.setObjectName("verticalLayout_26")
        self.widget = QtWidgets.QWidget(parent=self.verticalLayoutWidget_3)
        ...
        self.showLegendsCheckBox = QtWidgets.QCheckBox(parent=self.verticalLayoutWidget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.logScaleCheckBox = QtWidgets.QCheckBox(parent=self.verticalLayoutWidget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.rescalePushButton = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
